 ...
 * limitations under the License.
 */
class Se extends fn{constructor(t,n,i,e){var s;super(n.code,n.message),this.operationType=i,this.user=e,Object.setPrototypeOf(this,Se.prototype),this.customData={appName:t.name,tenantId:null!==(s=t.tenantId)&&void 0!==s?s:void 0,_serverResponse:n.customData._serverResponse,operationType:i}}static _fromErrorAndOperation(t,n,i,e){return new Se(t,n,i,e)}}function Ae(t,n,i,e){return("reauthenticate"===n?i._getReauthenticationResolver(t):i._getIdTokenResponse(t)).catch((i=>{if("auth/multi-factor-auth-required"===i.code)throw Se._fromErrorAndOperation(t,i,n,e);throw i}))}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ne(t,n,i=!1){const e="signIn",s=await Ae(t,e,n),r=await Ie._fromIdTokenResponse(t,e,s);return i||await t._updateCurrentUser(r.user),r}async function De(t,n){return Ne(re(t),n)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Hs="firebase-installations-store";let Js=null;function Ys(){return Js||(Js=Ds.openDb("firebase-installations-database",1,(t=>{switch(t.oldVersion){case 0:t.createObjectStore(Hs)}}))),Js}async function Xs(t,n){const i=Bs(t),e=(await Ys()).transaction(Hs,"readwrite"),s=e.objectStore(Hs),r=await s.get(i);return await s.put(n,i),await e.complete,r&&r.fid===n.fid||Ks(t,n.fid),n}async function Qs(t){const n=Bs(t),i=(await Ys()).transaction(Hs,"readwrite");await i.objectStore(Hs).delete(n),await i.complete}async function Zs(t,n){const i=Bs(t),e=(await Ys()).transaction(Hs,"readwrite"),s=e.objectStore(Hs),r=await s.get(i),o=n(r);return void 0===o?await s.delete(i):await s.put(o,i),await e.complete,!o||r&&r.fid===o.fid||Ks(t,o.fid),o}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ar(t){return yr.create("missing-app-config-values",{valueName:t})}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
Sr("hts/frbslgigp.ogepscmv/ieo/eaylg","tp:/ieaeogn-agolai.o/1frlglgc/o"),Sr("AzSCbw63g1R0nCw85jG8","Iaya3yLKwmgvh7cF0q4");class Cr{constructor(t,n,i){this.deliveryMetricsExportedToBigQueryEnabled=!1,this.onBackgroundMessageHandler=null,this.onMessageHandler=null,this.logEvents=[],this.isLogServiceStarted=!1;const e=function(t){if(!t||!t.options)throw Ar("App Configuration Object");if(!t.name)throw Ar("App Name");const n=["projectId","apiKey","appId","messagingSenderId"],{options:i}=t;for(const t of n)if(!i[t])throw Ar(t);return{appName:t.name,projectId:i.projectId,apiKey:i.apiKey,appId:i.appId,senderId:i.messagingSenderId}}(t);this.firebaseDependencies={app:t,appConfig:e,installations:n,analyticsProvider:i}}_delete(){return Promise.resolve()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dr="@firebase/messaging";async function Or(t,n){return Nr(t=Rn(t),n)}Yn(new Pn("messaging",(t=>{const n=new Cr(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",(t=>
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Co{put(t,n,i,e){}merge(t,n,i,e){}refreshAuthToken(t){}refreshAppCheckToken(t){}onDisconnectPut(t,n,i){}onDisconnectMerge(t,n,i){}onDisconnectCancel(t,n){}reportStats(t){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tl(t){return{type:"value",snapshotNode:t}}function Sl(t,n){return{type:"child_added",snapshotNode:n,childName:t}}function Al(t,n){return{type:"child_removed",snapshotNode:n,childName:t}}function Cl(t,n,i){return{type:"child_changed",snapshotNode:n,childName:t,oldSnap:i}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t,((t,e)=>{Vl(e,new Oo(n.toString()+"/"+t),i)}))}class zl{constructor(t){this.collection_=t,this.last_=null}get(){const t=this.collection_.get(),n=Object.assign({},t);return this.last_&&so(this.last_,((t,i)=>{n[t]=n[t]-i})),this.last_=t,n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ca{constructor(){this.changeMap=new Map}trackChildChange(t){const n=t.type,i=t.childName;Yt("child_added"===n||"child_changed"===n||"child_removed"===n,"Only child changes supported for tracking"),Yt(".priority"!==i,"Only non-priority child changes can be tracked.");const e=this.changeMap.get(i);if(e){const s=e.type;if("child_added"===n&&"child_removed"===s)this.changeMap.set(i,Cl(i,t.snapshotNode,e.snapshotNode));else if("child_removed"===n&&"child_added"===s)this.changeMap.delete(i);else if("child_removed"===n&&"child_changed"===s)this.changeMap.set(i,Al(i,e.oldSnap));else if("child_changed"===n&&"child_added"===s)this.changeMap.set(i,Sl(i,t.snapshotNode));else{if("child_changed"!==n||"child_changed"!==s)throw Xt("Illegal combination of changes: "+t+" occurred after "+e);this.changeMap.set(i,Cl(i,t.snapshotNode,e.oldSnap))}}else this.changeMap.set(i,t)}getChanges(){return Array.from(this.changeMap.values())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let qa,Ka;class Wa{constructor(){this.views=new Map}}function Ga(t,n,i,e){const s=n.source.queryId;if(null!==s){const r=t.views.get(s);return Yt(null!=r,"SyncTree gave us an op for an invalid query."),za(r,n,i,e)}{let s=[];for(const r of t.views.values())s=s.concat(za(r,n,i,e));return s}}function Ha(t){const n=[];for(const i of t.views.values())i.query._queryParams.loadsAllData()||n.push(i);return n}function Ja(t,n){let i=null;for(const e of t.views.values())i=i||$a(e,n);return i}function Ya(t,n){return n._queryParams.loadsAllData()?Za(t):t.views.get(n._queryIdentifier)}function Xa(t,n){return null!=Ya(t,n)}function Qa(t){return null!=Za(t)}function Za(t){for(const n of t.views.values())if(n.query._queryParams.loadsAllData())return n;return null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gp=new zn("@firebase/firestore");function Hp(){return Gp.logLevel}function Jp(t,...n){if(Gp.logLevel<=jn.DEBUG){const i=n.map(Qp);Gp.debug(`Firestore (${Wp}): ${t}`,...i)}}function Yp(t,...n){if(Gp.logLevel<=jn.ERROR){const i=n.map(Qp);Gp.error(`Firestore (${Wp}): ${t}`,...i)}}function Xp(t,...n){if(Gp.logLevel<=jn.WARN){const i=n.map(Qp);Gp.warn(`Firestore (${Wp}): ${t}`,...i)}}function Qp(t){if("string"==typeof t)return t;try{return JSON.stringify(t)}catch(n){return t}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return gg(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}Ag.EMPTY_BYTE_STRING=new Ag("");const Cg=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Ng(t){if(tg(!!t),"string"==typeof t){let n=0;const i=Cg.exec(t);if(tg(!!i),i[1]){let t=i[1];t=(t+"000000000").substr(0,9),n=Number(t)}const e=new Date(t);return{seconds:Math.floor(e.getTime()/1e3),nanos:n}}return{seconds:Dg(t.seconds),nanos:Dg(t.nanos)}}function Dg(t){return"number"==typeof t?t:"string"==typeof t?Number(t):0}function Og(t){return"string"==typeof t?Ag.fromBase64String(t):Ag.fromUint8Array(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ew=new bw(Fg.comparator);function Iw(){return Ew}const Tw=new bw(Fg.comparator);function Sw(){return Tw}const Aw=new bw(Fg.comparator),Cw=new kw(Fg.comparator);function Nw(...t){let n=Cw;for(const i of t)n=n.add(i);return n}const Dw=new kw(gg);function Ow(){return Dw}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bv{constructor(t){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,t((t=>{this.isDone=!0,this.result=t,this.nextCallback&&this.nextCallback(t)}),(t=>{this.isDone=!0,this.error=t,this.catchCallback&&this.catchCallback(t)}))}catch(t){return this.next(void 0,t)}next(t,n){return this.callbackAttached&&Zp(),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(n,this.error):this.wrapSuccess(t,this.result):new Bv(((i,e)=>{this.nextCallback=n=>{this.wrapSuccess(t,n).next(i,e)},this.catchCallback=t=>{this.wrapFailure(n,t).next(i,e)}}))}toPromise(){return new Promise(((t,n)=>{this.next(t,n)}))}wrapUserFunction(t){try{const n=t();return n instanceof Bv?n:Bv.resolve(n)}catch(t){return Bv.reject(t)}}wrapSuccess(t,n){return t?this.wrapUserFunction((()=>t(n))):Bv.resolve(n)}wrapFailure(t,n){return t?this.wrapUserFunction((()=>t(n))):Bv.reject(n)}static resolve(t){return new Bv((n=>{n(t)}))}static reject(t){return new Bv(((n,i)=>{i(t)}))}static waitFor(t){return new Bv(((n,i)=>{let e=0,s=0,r=!1;t.forEach((t=>{++e,t.next((()=>{++s,r&&s===e&&n()}),(t=>i(t)))})),r=!0,s===e&&n()}))}static or(t){let n=Bv.resolve(!1);for(const i of t)n=n.next((t=>t?Bv.resolve(t):i()));return n}static forEach(t,n){const i=[];return t.forEach(((t,e)=>{i.push(n.call(this,t,e))})),this.waitFor(i)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zv extends zv{constructor(t,n){super(),this.Wt=t,this.currentSequenceNumber=n}}function tb(t,n){return Kv.Dt(t.Wt,n)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bb{constructor(){this.Ht=new vb}addToCollectionParentIndex(t,n){if(!this.Ht.has(n)){const i=n.lastSegment(),e=n.popLast();t.addOnCommittedListener((()=>{this.Ht.add(n)}));const s={collectionId:i,parent:yv(e)};return yb(t).put(s)}return Bv.resolve()}getCollectionParents(t,n){const i=[],e=IDBKeyRange.bound([n,""],[wg(n),""],!1,!0);return yb(t).Bt(e).next((t=>{for(const e of t){if(e.collectionId!==n)break;i.push(_v(e.parent))}return i}))}}function yb(t){return tb(t,Lv.store)}
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _b(t,n,i){const e=t.store(Sv.store),s=t.store(Av.store),r=[],o=IDBKeyRange.only(i.batchId);let l=0;const a=e.jt({range:o},((t,n,i)=>(l++,i.delete())));r.push(a.next((()=>{tg(1===l)})));const u=[];for(const t of i.mutations){const e=Av.key(n,t.key.path,i.batchId);r.push(s.delete(e)),u.push(t.key)}return Bv.waitFor(r).next((()=>u))}function Eb(t){if(!t)return 0;let n;if(t.document)n=t.document;else if(t.unknownDocument)n=t.unknownDocument;else{if(!t.noDocument)throw Zp();n=t.noDocument}return JSON.stringify(n).length}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */kb.DEFAULT_COLLECTION_PERCENTILE=10,kb.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,kb.DEFAULT=new kb(41943040,kb.DEFAULT_COLLECTION_PERCENTILE,kb.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),kb.DISABLED=new kb(-1,0,0);class Ib{constructor(t,n,i,e){this.userId=t,this.k=n,this.Jt=i,this.referenceDelegate=e,this.Yt={}}static Xt(t,n,i,e){tg(""!==t.uid);const s=t.isAuthenticated()?t.uid:"";return new Ib(s,n,i,e)}checkEmpty(t){let n=!0;const i=IDBKeyRange.bound([this.userId,Number.NEGATIVE_INFINITY],[this.userId,Number.POSITIVE_INFINITY]);return Sb(t).jt({index:Sv.userMutationsIndex,range:i},((t,i,e)=>{n=!1,e.done()})).next((()=>n))}addMutationBatch(t,n,i,e){const s=Ab(t),r=Sb(t);return r.add({}).next((o=>{tg("number"==typeof o);const l=new nb(o,n,i,e),a=function(t,n,i){const e=i.baseMutations.map((n=>sv(t.Gt,n))),s=i.mutations.map((n=>sv(t.Gt,n)));return new Sv(n,i.batchId,i.localWriteTime.toMillis(),e,s)}(this.k,this.userId,l),u=[];let h=new kw(((t,n)=>gg(t.canonicalString(),n.canonicalString())));for(const t of e){const n=Av.key(this.userId,t.key.path,o);h=h.add(t.key.path.popLast()),u.push(r.put(a)),u.push(s.put(n,Av.PLACEHOLDER))}return h.forEach((n=>{u.push(this.Jt.addToCollectionParentIndex(t,n))})),t.addOnCommittedListener((()=>{this.Yt[o]=l.keys()})),Bv.waitFor(u).next((()=>l))}))}lookupMutationBatch(t,n){return Sb(t).get(n).next((t=>t?(tg(t.userId===this.userId),hb(this.k,t)):null))}Zt(t,n){return this.Yt[n]?Bv.resolve(this.Yt[n]):this.lookupMutationBatch(t,n).next((t=>{if(t){const i=t.keys();return this.Yt[n]=i,i}return null}))}getNextMutationBatchAfterBatchId(t,n){const i=n+1,e=IDBKeyRange.lowerBound([this.userId,i]);let s=null;return Sb(t).jt({index:Sv.userMutationsIndex,range:e},((t,n,e)=>{n.userId===this.userId&&(tg(n.batchId>=i),s=hb(this.k,n)),e.done()})).next((()=>s))}getHighestUnacknowledgedBatchId(t){const n=IDBKeyRange.upperBound([this.userId,Number.POSITIVE_INFINITY]);let i=-1;return Sb(t).jt({index:Sv.userMutationsIndex,range:n,reverse:!0},((t,n,e)=>{i=n.batchId,e.done()})).next((()=>i))}getAllMutationBatches(t){const n=IDBKeyRange.bound([this.userId,-1],[this.userId,Number.POSITIVE_INFINITY]);return Sb(t).Bt(Sv.userMutationsIndex,n).next((t=>t.map((t=>hb(this.k,t)))))}getAllMutationBatchesAffectingDocumentKey(t,n){const i=Av.prefixForPath(this.userId,n.path),e=IDBKeyRange.lowerBound(i),s=[];return Ab(t).jt({range:e},((i,e,r)=>{const[o,l,a]=i,u=_v(l);if(o===this.userId&&n.path.isEqual(u))return Sb(t).get(a).next((t=>{if(!t)throw Zp();tg(t.userId===this.userId),s.push(hb(this.k,t))}));r.done()})).next((()=>s))}getAllMutationBatchesAffectingDocumentKeys(t,n){let i=new kw(gg);const e=[];return n.forEach((n=>{const s=Av.prefixForPath(this.userId,n.path),r=IDBKeyRange.lowerBound(s),o=Ab(t).jt({range:r},((t,e,s)=>{const[r,o,l]=t,a=_v(o);r===this.userId&&n.path.isEqual(a)?i=i.add(l):s.done()}));e.push(o)})),Bv.waitFor(e).next((()=>this.te(t,i)))}getAllMutationBatchesAffectingQuery(t,n){const i=n.path,e=i.length+1,s=Av.prefixForPath(this.userId,i),r=IDBKeyRange.lowerBound(s);let o=new kw(gg);return Ab(t).jt({range:r},((t,n,s)=>{const[r,l,a]=t,u=_v(l);r===this.userId&&i.isPrefixOf(u)?u.length===e&&(o=o.add(a)):s.done()})).next((()=>this.te(t,o)))}te(t,n){const i=[],e=[];return n.forEach((n=>{e.push(Sb(t).get(n).next((t=>{if(null===t)throw Zp();tg(t.userId===this.userId),i.push(hb(this.k,t))})))})),Bv.waitFor(e).next((()=>i))}removeMutationBatch(t,n){return _b(t.Wt,this.userId,n).next((i=>(t.addOnCommittedListener((()=>{this.ee(n.batchId)})),Bv.forEach(i,(n=>this.referenceDelegate.markPotentiallyOrphaned(t,n))))))}ee(t){delete this.Yt[t]}performConsistencyCheck(t){return this.checkEmpty(t).next((n=>{if(!n)return Bv.resolve();const i=IDBKeyRange.lowerBound(Av.prefixForUser(this.userId)),e=[];return Ab(t).jt({range:i},((t,n,i)=>{if(t[0]===this.userId){const n=_v(t[1]);e.push(n)}else i.done()})).next((()=>{tg(0===e.length)}))}))}containsKey(t,n){return Tb(t,this.userId,n)}ne(t){return Cb(t).get(this.userId).next((t=>t||new Tv(this.userId,-1,"")))}}function Tb(t,n,i){const e=Av.prefixForPath(n,i.path),s=e[1],r=IDBKeyRange.lowerBound(e);let o=!1;return Ab(t).jt({range:r,Kt:!0},((t,i,e)=>{const[r,l,a]=t;r===n&&l===s&&(o=!0),e.done()})).next((()=>o))}function Sb(t){return tb(t,Sv.store)}function Ab(t){return tb(t,Av.store)}function Cb(t){return tb(t,Tv.store)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class cy{constructor(t){this.k=t,this.Xn=new Map,this.Zn=new Map}getBundleMetadata(t,n){return Bv.resolve(this.Xn.get(n))}saveBundleMetadata(t,n){var i;return this.Xn.set(n.id,{id:(i=n).id,version:i.version,createTime:Hw(i.createTime)}),Bv.resolve()}getNamedQuery(t,n){return Bv.resolve(this.Zn.get(n))}saveNamedQuery(t,n){return this.Zn.set(n.name,function(t){return{name:t.name,query:fb(t.bundledQuery),readTime:Hw(t.readTime)}}(n)),Bv.resolve()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class py{constructor(t,n){this.Jt=t,this.referenceDelegate=n,this.An=[],this.ds=1,this.ws=new kw(fy.es)}checkEmpty(t){return Bv.resolve(0===this.An.length)}addMutationBatch(t,n,i,e){const s=this.ds;this.ds++;const r=new nb(s,n,i,e);this.An.push(r);for(const n of e)this.ws=this.ws.add(new fy(n.key,s)),this.Jt.addToCollectionParentIndex(t,n.key.path.popLast());return Bv.resolve(r)}lookupMutationBatch(t,n){return Bv.resolve(this._s(n))}getNextMutationBatchAfterBatchId(t,n){const i=this.gs(n+1),e=i<0?0:i;return Bv.resolve(this.An.length>e?this.An[e]:null)}getHighestUnacknowledgedBatchId(){return Bv.resolve(0===this.An.length?-1:this.ds-1)}getAllMutationBatches(t){return Bv.resolve(this.An.slice())}getAllMutationBatchesAffectingDocumentKey(t,n){const i=new fy(n,0),e=new fy(n,Number.POSITIVE_INFINITY),s=[];return this.ws.forEachInRange([i,e],(t=>{const n=this._s(t.fs);s.push(n)})),Bv.resolve(s)}getAllMutationBatchesAffectingDocumentKeys(t,n){let i=new kw(gg);return n.forEach((t=>{const n=new fy(t,0),e=new fy(t,Number.POSITIVE_INFINITY);this.ws.forEachInRange([n,e],(t=>{i=i.add(t.fs)}))})),Bv.resolve(this.ys(i))}getAllMutationBatchesAffectingQuery(t,n){const i=n.path,e=i.length+1;let s=i;Fg.isDocumentKey(s)||(s=s.child(""));const r=new fy(new Fg(s),0);let o=new kw(gg);return this.ws.forEachWhile((t=>{const n=t.key.path;return!!i.isPrefixOf(n)&&(n.length===e&&(o=o.add(t.fs)),!0)}),r),Bv.resolve(this.ys(o))}ys(t){const n=[];return t.forEach((t=>{const i=this._s(t);null!==i&&n.push(i)})),n}removeMutationBatch(t,n){tg(0===this.ps(n.batchId,"removed")),this.An.shift();let i=this.ws;return Bv.forEach(n.mutations,(e=>{const s=new fy(e.key,n.batchId);return i=i.delete(s),this.referenceDelegate.markPotentiallyOrphaned(t,e.key)})).next((()=>{this.ws=i}))}ee(t){}containsKey(t,n){const i=new fy(n,0),e=this.ws.firstAfterOrEqual(i);return Bv.resolve(n.isEqual(e&&e.key))}performConsistencyCheck(t){return Bv.resolve()}ps(t,n){return this.gs(t)}gs(t){return 0===this.An.length?0:t-this.An[0].batchId}_s(t){const n=this.gs(t);return n<0||n>=this.An.length?null:this.An[n]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gy{constructor(t,n){this.Jt=t,this.Ts=n,this.docs=new bw(Fg.comparator),this.size=0}addEntry(t,n,i){const e=n.key,s=this.docs.get(e),r=s?s.size:0,o=this.Ts(n);return this.docs=this.docs.insert(e,{document:n.clone(),size:o,readTime:i}),this.size+=o-r,this.Jt.addToCollectionParentIndex(t,e.path.popLast())}removeEntry(t){const n=this.docs.get(t);n&&(this.docs=this.docs.remove(t),this.size-=n.size)}getEntry(t,n){const i=this.docs.get(n);return Bv.resolve(i?i.document.clone():nm.newInvalidDocument(n))}getEntries(t,n){let i=Iw();return n.forEach((t=>{const n=this.docs.get(t);i=i.insert(t,n?n.document.clone():nm.newInvalidDocument(t))})),Bv.resolve(i)}getDocumentsMatchingQuery(t,n,i){let e=Iw();const s=new Fg(n.path.child("")),r=this.docs.getIteratorFrom(s);for(;r.hasNext();){const{key:t,value:{document:s,readTime:o}}=r.getNext();if(!n.path.isPrefixOf(t.path))break;o.compareTo(i)<=0||Mm(n,s)&&(e=e.insert(s.key,s.clone()))}return Bv.resolve(e)}Es(t,n){return Bv.forEach(this.docs,(t=>n(t)))}newChangeBuffer(t){return new my(this)}getSize(t){return Bv.resolve(this.size)}}class my extends Bb{constructor(t){super(),this.De=t}applyChanges(t){const n=[];return this.changes.forEach(((i,e)=>{e.document.isValidDocument()?n.push(this.De.addEntry(t,e.document,this.getReadTime(i))):this.De.removeEntry(i)})),Bv.waitFor(n)}getFromCache(t,n){return this.De.getEntry(t,n)}getAllFromCache(t,n){return this.De.getEntries(t,n)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wy{constructor(t){this.persistence=t,this.Is=new zb((t=>sm(t)),rm),this.lastRemoteSnapshotVersion=bg.min(),this.highestTargetId=0,this.As=0,this.Rs=new dy,this.targetCount=0,this.Ps=Nb.ie()}forEachTarget(t,n){return this.Is.forEach(((t,i)=>n(i))),Bv.resolve()}getLastRemoteSnapshotVersion(t){return Bv.resolve(this.lastRemoteSnapshotVersion)}getHighestSequenceNumber(t){return Bv.resolve(this.As)}allocateTargetId(t){return this.highestTargetId=this.Ps.next(),Bv.resolve(this.highestTargetId)}setTargetsMetadata(t,n,i){return i&&(this.lastRemoteSnapshotVersion=i),n>this.As&&(this.As=n),Bv.resolve()}ce(t){this.Is.set(t.target,t);const n=t.targetId;n>this.highestTargetId&&(this.Ps=new Nb(n),this.highestTargetId=n),t.sequenceNumber>this.As&&(this.As=t.sequenceNumber)}addTargetData(t,n){return this.ce(n),this.targetCount+=1,Bv.resolve()}updateTargetData(t,n){return this.ce(n),Bv.resolve()}removeTargetData(t,n){return this.Is.delete(n.target),this.Rs.us(n.targetId),this.targetCount-=1,Bv.resolve()}removeTargets(t,n,i){let e=0;const s=[];return this.Is.forEach(((r,o)=>{o.sequenceNumber<=n&&null===i.get(o.targetId)&&(this.Is.delete(r),s.push(this.removeMatchingKeysForTargetId(t,o.targetId)),e++)})),Bv.waitFor(s).next((()=>e))}getTargetCount(t){return Bv.resolve(this.targetCount)}getTargetData(t,n){const i=this.Is.get(n)||null;return Bv.resolve(i)}addMatchingKeys(t,n,i){return this.Rs.rs(n,i),Bv.resolve()}removeMatchingKeys(t,n,i){this.Rs.cs(n,i);const e=this.persistence.referenceDelegate,s=[];return e&&n.forEach((n=>{s.push(e.markPotentiallyOrphaned(t,n))})),Bv.waitFor(s)}removeMatchingKeysForTargetId(t,n){return this.Rs.us(n),Bv.resolve()}getMatchingKeysForTargetId(t,n){const i=this.Rs.ls(n);return Bv.resolve(i)}containsKey(t,n){return Bv.resolve(this.Rs.containsKey(n))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vy{constructor(t,n){this.bs={},this.Be=new dg(0),this.Ue=!1,this.Ue=!0,this.referenceDelegate=t(this),this.He=new wy(this),this.Jt=new wb,this.Je=function(t,n){return new gy(t,n)}(this.Jt,(t=>this.referenceDelegate.vs(t))),this.k=new sb(n),this.Ye=new cy(this.k)}start(){return Promise.resolve()}shutdown(){return this.Ue=!1,Promise.resolve()}get started(){return this.Ue}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(){return this.Jt}getMutationQueue(t){let n=this.bs[t.toKey()];return n||(n=new py(this.Jt,this.referenceDelegate),this.bs[t.toKey()]=n),n}getTargetCache(){return this.He}getRemoteDocumentCache(){return this.Je}getBundleCache(){return this.Ye}runTransaction(t,n,i){Jp("MemoryPersistence","Starting transaction:",t);const e=new by(this.Be.next());return this.referenceDelegate.Vs(),i(e).next((t=>this.referenceDelegate.Ss(e).next((()=>t)))).toPromise().then((t=>(e.raiseOnCommittedEvent(),t)))}Ds(t,n){return Bv.or(Object.values(this.bs).map((i=>()=>i.containsKey(t,n))))}}class by extends zv{constructor(t){super(),this.currentSequenceNumber=t}}class yy{constructor(t){this.persistence=t,this.Cs=new dy,this.Ns=null}static ks(t){return new yy(t)}get xs(){if(this.Ns)return this.Ns;throw Zp()}addReference(t,n,i){return this.Cs.addReference(i,n),this.xs.delete(i.toString()),Bv.resolve()}removeReference(t,n,i){return this.Cs.removeReference(i,n),this.xs.add(i.toString()),Bv.resolve()}markPotentiallyOrphaned(t,n){return this.xs.add(n.toString()),Bv.resolve()}removeTarget(t,n){this.Cs.us(n.targetId).forEach((t=>this.xs.add(t.toString())));const i=this.persistence.getTargetCache();return i.getMatchingKeysForTargetId(t,n.targetId).next((t=>{t.forEach((t=>this.xs.add(t.toString())))})).next((()=>i.removeTargetData(t,n)))}Vs(){this.Ns=new Set}Ss(t){const n=this.persistence.getRemoteDocumentCache().newChangeBuffer();return Bv.forEach(this.xs,(i=>{const e=Fg.fromPath(i);return this.$s(t,e).next((t=>{t||n.removeEntry(e)}))})).next((()=>(this.Ns=null,n.apply(t))))}updateLimboDocument(t,n){return this.$s(t,n).next((t=>{t?this.xs.delete(n.toString()):this.xs.add(n.toString())}))}vs(t){return 0}$s(t,n){return Bv.or([()=>Bv.resolve(this.Cs.containsKey(n)),()=>this.persistence.getTargetCache().containsKey(t,n),()=>this.persistence.Ds(t,n)])}}class xy{constructor(){this.activeTargetIds=Ow()}Ms(t){this.activeTargetIds=this.activeTargetIds.add(t)}Ls(t){this.activeTargetIds=this.activeTargetIds.delete(t)}Os(){const t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(t)}}class ky{constructor(){this.pi=new xy,this.Ti={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(t){}updateMutationState(t,n,i){}addLocalQueryTarget(t){return this.pi.Ms(t),this.Ti[t]||"not-current"}updateQueryState(t,n,i){this.Ti[t]=n}removeLocalQueryTarget(t){this.pi.Ls(t)}isLocalQueryTarget(t){return this.pi.activeTargetIds.has(t)}clearQueryState(t){delete this.Ti[t]}getAllActiveQueryTargets(){return this.pi.activeTargetIds}isActiveQueryTarget(t){return this.pi.activeTargetIds.has(t)}start(){return this.pi=new xy,Promise.resolve()}handleUserChange(t,n,i){}setOnlineState(t){}shutdown(){}writeSequenceNumber(t){}notifyBundleLoaded(){}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xk{constructor(t){this._byteString=t}static fromBase64String(t){try{return new xk(Ag.fromBase64String(t))}catch(t){throw new ig(ng.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(t){return new xk(Ag.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zk{constructor(t,n,i,e,s){this._firestore=t,this._userDataWriter=n,this._key=i,this._document=e,this._converter=s}get id(){return this._key.path.lastSegment()}get ref(){return new ck(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){const t=new Bk(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(t)}return this._userDataWriter.convertValue(this._document.data.value)}}get(t){if(this._document){const n=this._document.data.field(qk("DocumentSnapshot.get",t));if(null!==n)return this._userDataWriter.convertValue(n)}}}class Bk extends zk{data(){return super.data()}}function qk(t,n){return"string"==typeof n?$k(t,n):n instanceof yk?n._internalPath:n._delegate._internalPath}
/**
 * @license
 * Copyright 2020 Google LLC
 *
