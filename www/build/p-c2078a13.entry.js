 ...
 * limitations under the License.
 */
const Hs="firebase-installations-store";let Ys=null;function Js(){return Ys||(Ys=Ds.openDb("firebase-installations-database",1,(t=>{switch(t.oldVersion){case 0:t.createObjectStore(Hs)}}))),Ys}async function Xs(t,n){const i=zs(t),e=(await Js()).transaction(Hs,"readwrite"),s=e.objectStore(Hs),r=await s.get(i);return await s.put(n,i),await e.complete,r&&r.fid===n.fid||Ks(t,n.fid),n}async function Qs(t){const n=zs(t),i=(await Js()).transaction(Hs,"readwrite");await i.objectStore(Hs).delete(n),await i.complete}async function Zs(t,n){const i=zs(t),e=(await Js()).transaction(Hs,"readwrite"),s=e.objectStore(Hs),r=await s.get(i),o=n(r);return void 0===o?await s.delete(i):await s.put(o,i),await e.complete,!o||r&&r.fid===o.fid||Ks(t,o.fid),o}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class So{constructor(t){this.initTransports_(t)}static get ALL_TRANSPORTS(){return[ko,To]}initTransports_(t){const n=To&&To.isAvailable();let i=n&&!To.previouslyFailed();if(t.webSocketOnly&&(n||Yr("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),i=!0),i)this.transports_=[To];else{const t=this.transports_=[];for(const n of So.ALL_TRANSPORTS)n&&n.isAvailable()&&t.push(n)}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class No{constructor(t){this.allowedEvents_=t,this.listeners_={},Jt(Array.isArray(t)&&t.length>0,"Requires a non-empty array")}trigger(t,...n){if(Array.isArray(this.listeners_[t])){const i=[...this.listeners_[t]];for(let t=0;t<i.length;t++)i[t].callback.apply(i[t].context,n)}}on(t,n,i){this.validateEventType_(t),this.listeners_[t]=this.listeners_[t]||[],this.listeners_[t].push({callback:n,context:i});const e=this.getInitialEvent(t);e&&n.apply(i,e)}off(t,n,i){this.validateEventType_(t);const e=this.listeners_[t]||[];for(let t=0;t<e.length;t++)if(e[t].callback===n&&(!i||i===e[t].context))return void e.splice(t,1)}validateEventType_(t){Jt(this.allowedEvents_.find((n=>n===t)),"Unknown event: "+t)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Do extends No{constructor(){super(["online"]),this.online_=!0,"undefined"==typeof window||void 0===window.addEventListener||an()||(window.addEventListener("online",(()=>{this.online_||(this.online_=!0,this.trigger("online",!0))}),!1),window.addEventListener("offline",(()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))}),!1))}static getInstance(){return new Do}getInitialEvent(t){return Jt("online"===t,"Unknown event type: "+t),[this.online_]}currentlyOnline(){return this.online_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let wl;const vl={};class bl{constructor(t,n){this.indexes_=t,this.indexSet_=n}static get Default(){return Jt(vl&&fl,"ChildrenNode.ts has not been loaded"),wl=wl||new bl({".priority":vl},{".priority":fl}),wl}get(t){const n=yn(this.indexes_,t);if(!n)throw new Error("No index defined for "+t);return n instanceof el?n:null}hasIndex(t){return bn(this.indexSet_,t.toString())}addIndex(t,n){Jt(t!==tl,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let e=!1;const s=n.getIterator(Xo.Wrap);let r,o=s.getNext();for(;o;)e=e||t.isDefinedOn(o.node),i.push(o),o=s.getNext();r=e?ml(i,t.getCompare()):vl;const l=t.toString(),a=Object.assign({},this.indexSet_);a[l]=t;const u=Object.assign({},this.indexes_);return u[l]=r,new bl(u,a)}addToIndexes(t,n){const i=kn(this.indexes_,((i,e)=>{const s=yn(this.indexSet_,e);if(Jt(s,"Missing index implementation for "+e),i===vl){if(s.isDefinedOn(t.node)){const i=[],e=n.getIterator(Xo.Wrap);let r=e.getNext();for(;r;)r.name!==t.name&&i.push(r),r=e.getNext();return i.push(t),ml(i,s.getCompare())}return vl}{const e=n.get(t.name);let s=i;return e&&(s=s.remove(new Xo(t.name,e))),s.insert(t,t.node)}}));return new bl(i,this.indexSet_)}removeFromIndexes(t,n){const i=kn(this.indexes_,(i=>{if(i===vl)return i;{const e=n.get(t.name);return e?i.remove(new Xo(t.name,e)):i}}));return new bl(i,this.indexSet_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Nl{constructor(t){this.index_=t}updateChild(t,n,i,e,s,r){Jt(t.isIndexed(this.index_),"A node must be indexed if only a child is updated");const o=t.getImmediateChild(n);return o.getChild(e).equals(i.getChild(e))&&o.isEmpty()===i.isEmpty()?t:(null!=r&&(i.isEmpty()?t.hasChild(n)?r.trackChildChange(Cl(n,o)):Jt(t.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):o.isEmpty()?r.trackChildChange(Sl(n,i)):r.trackChildChange(Al(n,i,o))),t.isLeafNode()&&i.isEmpty()?t:t.updateImmediateChild(n,i).withIndex(this.index_))}updateFullNode(t,n,i){return null!=i&&(t.isLeafNode()||t.forEachChild(fl,((t,e)=>{n.hasChild(t)||i.trackChildChange(Cl(t,e))})),n.isLeafNode()||n.forEachChild(fl,((n,e)=>{if(t.hasChild(n)){const s=t.getImmediateChild(n);s.equals(e)||i.trackChildChange(Al(n,e,s))}else i.trackChildChange(Sl(n,e))}))),n.withIndex(this.index_)}updatePriority(t,n){return t.isEmpty()?xl.EMPTY_NODE:t.updatePriority(n)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rl{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=fl}hasStart(){return this.startSet_}hasStartAfter(){return this.startAfterSet_}hasEndBefore(){return this.endBeforeSet_}isViewFromLeft(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}getIndexStartValue(){return Jt(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return Jt(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:Xr}hasEnd(){return this.endSet_}getIndexEndValue(){return Jt(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return Jt(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:Qr}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&""!==this.viewFrom_}getLimit(){return Jt(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===fl}copy(){const t=new Rl;return t.limitSet_=this.limitSet_,t.limit_=this.limit_,t.startSet_=this.startSet_,t.indexStartValue_=this.indexStartValue_,t.startNameSet_=this.startNameSet_,t.indexStartName_=this.indexStartName_,t.endSet_=this.endSet_,t.indexEndValue_=this.indexEndValue_,t.endNameSet_=this.endNameSet_,t.indexEndName_=this.indexEndName_,t.index_=this.index_,t.viewFrom_=this.viewFrom_,t}}function Pl(t){const n={};if(t.isDefault())return n;let i;return t.index_===fl?i="$priority":t.index_===Il?i="$value":t.index_===tl?i="$key":(Jt(t.index_ instanceof El,"Unrecognized index type!"),i=t.index_.toString()),n.orderBy=wn(i),t.startSet_&&(n.startAt=wn(t.indexStartValue_),t.startNameSet_&&(n.startAt+=","+wn(t.indexStartName_))),t.endSet_&&(n.endAt=wn(t.indexEndValue_),t.endNameSet_&&(n.endAt+=","+wn(t.indexEndName_))),t.limitSet_&&(t.isViewFromLeft()?n.limitToFirst=t.limit_:n.limitToLast=t.limit_),n}function Ml(t){const n={};if(t.startSet_&&(n.sp=t.indexStartValue_,t.startNameSet_&&(n.sn=t.indexStartName_)),t.endSet_&&(n.ep=t.indexEndValue_,t.endNameSet_&&(n.en=t.indexEndName_)),t.limitSet_){n.l=t.limit_;let i=t.viewFrom_;""===i&&(i=t.isViewFromLeft()?"l":"r"),n.vf=i}return t.index_!==fl&&(n.i=t.index_.toString()),n}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */!function(t){t[t.OVERWRITE=0]="OVERWRITE",t[t.MERGE=1]="MERGE",t[t.ACK_USER_WRITE=2]="ACK_USER_WRITE",t[t.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"}(ql||(ql={}));class Wl{constructor(t,n,i){this.path=t,this.affectedTree=n,this.revert=i,this.type=ql.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}operationForChild(t){if(Vo(this.path)){if(null!=this.affectedTree.value)return Jt(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new Oo(t));return new Wl(Ro(),n,this.revert)}}return Jt(Po(this.path)===t,"operationForChild called for unrelated child."),new Wl(Lo(this.path),this.affectedTree,this.revert)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yl{constructor(t,n,i){this.source=t,this.path=n,this.children=i,this.type=ql.MERGE}operationForChild(t){if(Vo(this.path)){const n=this.children.subtree(new Oo(t));return n.isEmpty()?null:n.value?new Hl(this.source,Ro(),n.value):new Yl(this.source,Ro(),n)}return Jt(Po(this.path)===t,"Can't get a merge for a child not on the path of the operation"),new Yl(this.source,Lo(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t,n,i))),o.forEach((i=>{const e=function(t,n,i){return"value"===n.type||"child_removed"===n.type||(n.prevName=i.getPredecessorChildName(n.childName,n.snapshotNode,t.index_)),n}(t,i,r);s.forEach((s=>{s.respondsTo(i.type)&&n.push(s.createEvent(e,t.query_))}))}))}function Zl(t,n){return{eventCache:t,serverCache:n}}function ta(t,n,i,e){return Zl(new Jl(n,i,e),t.serverCache)}function na(t,n,i,e){return Zl(t.eventCache,new Jl(n,i,e))}function ia(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function ea(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let qa,Ka;class Wa{constructor(){this.views=new Map}}function Ga(t,n,i,e){const s=n.source.queryId;if(null!==s){const r=t.views.get(s);return Jt(null!=r,"SyncTree gave us an op for an invalid query."),Ba(r,n,i,e)}{let s=[];for(const r of t.views.values())s=s.concat(Ba(r,n,i,e));return s}}function Ha(t){const n=[];for(const i of t.views.values())i.query._queryParams.loadsAllData()||n.push(i);return n}function Ya(t,n){let i=null;for(const e of t.views.values())i=i||$a(e,n);return i}function Ja(t,n){return n._queryParams.loadsAllData()?Za(t):t.views.get(n._queryIdentifier)}function Xa(t,n){return null!=Ja(t,n)}function Qa(t){return null!=Za(t)}function Za(t){for(const n of t.views.values())if(n.query._queryParams.loadsAllData())return n;return null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gp=new Bn("@firebase/firestore");function Hp(){return Gp.logLevel}function Yp(t,...n){if(Gp.logLevel<=jn.DEBUG){const i=n.map(Qp);Gp.debug(`Firestore (${Wp}): ${t}`,...i)}}function Jp(t,...n){if(Gp.logLevel<=jn.ERROR){const i=n.map(Qp);Gp.error(`Firestore (${Wp}): ${t}`,...i)}}function Xp(t,...n){if(Gp.logLevel<=jn.WARN){const i=n.map(Qp);Gp.warn(`Firestore (${Wp}): ${t}`,...i)}}function Qp(t){if("string"==typeof t)return t;try{return JSON.stringify(t)}catch(n){return t}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zp(t="Unexpected state"){const n=`FIRESTORE (${Wp}) INTERNAL ASSERTION FAILED: `+t;throw Jp(n),new Error(n)}function tg(t){t||Zp()}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sg{constructor(t,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class rg{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,n){t.enqueueRetryable((()=>n(Kp.UNAUTHENTICATED)))}shutdown(){}}class og{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,n){this.changeListener=n,t.enqueueRetryable((()=>n(this.token.user)))}shutdown(){this.changeListener=null}}class lg{constructor(t){this.t=t,this.currentUser=Kp.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,n){let i=this.i;const e=t=>this.i!==i?(i=this.i,n(t)):Promise.resolve();let s=new eg;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new eg,t.enqueueRetryable((()=>e(this.currentUser)))};const r=()=>{const n=s;t.enqueueRetryable((async()=>{await n.promise,await e(this.currentUser)}))},o=t=>{Yp("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=t,this.auth.addAuthTokenListener(this.o),r()};this.t.onInit((t=>o(t))),setTimeout((()=>{if(!this.auth){const t=this.t.getImmediate({optional:!0});t?o(t):(Yp("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new eg)}}),0),r()}getToken(){const t=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then((n=>this.i!==t?(Yp("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):n?(tg("string"==typeof n.accessToken),new sg(n.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const t=this.auth&&this.auth.getUid();return tg(null===t||"string"==typeof t),new Kp(t)}}class ag{constructor(t,n,i){this.type="FirstParty",this.user=Kp.FIRST_PARTY,this.headers=new Map,this.headers.set("X-Goog-AuthUser",n);const e=t.auth.getAuthHeaderValueForFirstParty([]);e&&this.headers.set("Authorization",e),i&&this.headers.set("X-Goog-Iam-Authorization-Token",i)}}class ug{constructor(t,n,i){this.h=t,this.l=n,this.m=i}getToken(){return Promise.resolve(new ag(this.h,this.l,this.m))}start(t,n){t.enqueueRetryable((()=>n(Kp.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class hg{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class cg{constructor(t){this.g=t,this.forceRefresh=!1,this.appCheck=null}start(t,n){this.o=i=>{t.enqueueRetryable((()=>(t=>(null!=t.error&&Yp("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${t.error.message}`),n(t.token)))(i)))};const i=t=>{Yp("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=t,this.appCheck.addTokenListener(this.o)};this.g.onInit((t=>i(t))),setTimeout((()=>{if(!this.appCheck){const t=this.g.getImmediate({optional:!0});t?i(t):Yp("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then((t=>t?(tg("string"==typeof t.token),new hg(t.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qv{constructor(t,n){this.action=t,this.transaction=n,this.aborted=!1,this.It=new eg,this.transaction.oncomplete=()=>{this.It.resolve()},this.transaction.onabort=()=>{n.error?this.It.reject(new Gv(t,n.error)):this.It.resolve()},this.transaction.onerror=n=>{const i=Qv(n.target.error);this.It.reject(new Gv(t,i))}}static open(t,n,i,e){try{return new qv(n,t.transaction(e,i))}catch(t){throw new Gv(n,t)}}get At(){return this.It.promise}abort(t){t&&this.It.reject(t),this.aborted||(Yp("SimpleDb","Aborting transaction:",t?t.message:"Client-initiated abort"),this.aborted=!0,this.transaction.abort())}store(t){const n=this.transaction.objectStore(t);return new Yv(n)}}class Kv{constructor(t,n,i){this.name=t,this.version=n,this.Rt=i,12.2===Kv.Pt(ln())&&Jp("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.")}static delete(t){return Yp("SimpleDb","Removing database:",t),Jv(window.indexedDB.deleteDatabase(t)).toPromise()}static bt(){if(!dn())return!1;if(Kv.vt())return!0;const t=ln(),n=Kv.Pt(t),i=0<n&&n<10,e=Kv.Vt(t),s=0<e&&e<4.5;return!(t.indexOf("MSIE ")>0||t.indexOf("Trident/")>0||t.indexOf("Edge/")>0||i||s)}static vt(){var t;return"undefined"!=typeof process&&"YES"===(null===(t=process.env)||void 0===t?void 0:t.St)}static Dt(t,n){return t.store(n)}static Pt(t){const n=t.match(/i(?:phone|pad|pod) os ([\d_]+)/i),i=n?n[1].split("_").slice(0,2).join("."):"-1";return Number(i)}static Vt(t){const n=t.match(/Android ([\d.]+)/i),i=n?n[1].split(".").slice(0,2).join("."):"-1";return Number(i)}async Ct(t){return this.db||(Yp("SimpleDb","Opening database:",this.name),this.db=await new Promise(((n,i)=>{const e=indexedDB.open(this.name,this.version);e.onsuccess=t=>{n(t.target.result)},e.onblocked=()=>{i(new Gv(t,"Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."))},e.onerror=n=>{const e=n.target.error;i("VersionError"===e.name?new ig(ng.FAILED_PRECONDITION,"A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh."):"InvalidStateError"===e.name?new ig(ng.FAILED_PRECONDITION,"Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: "+e):new Gv(t,e))},e.onupgradeneeded=t=>{Yp("SimpleDb",'Database "'+this.name+'" requires upgrade from version:',t.oldVersion),this.Rt.Nt(t.target.result,e.transaction,t.oldVersion,this.version).next((()=>{Yp("SimpleDb","Database upgrade to version "+this.version+" complete")}))}}))),this.kt&&(this.db.onversionchange=t=>this.kt(t)),this.db}xt(t){this.kt=t,this.db&&(this.db.onversionchange=n=>t(n))}async runTransaction(t,n,i,e){const s="readonly"===n;let r=0;for(;;){++r;try{this.db=await this.Ct(t);const n=qv.open(this.db,t,s?"readonly":"readwrite",i),r=e(n).catch((t=>(n.abort(t),zv.reject(t)))).toPromise();return r.catch((()=>{})),await n.At,r}catch(t){const n="FirebaseError"!==t.name&&r<3;if(Yp("SimpleDb","Transaction failed with error:",t.message,"Retrying:",n),this.close(),!n)return Promise.reject(t)}}}close(){this.db&&this.db.close(),this.db=void 0}}class Wv{constructor(t){this.$t=t,this.Ft=!1,this.Ot=null}get isDone(){return this.Ft}get Mt(){return this.Ot}set cursor(t){this.$t=t}done(){this.Ft=!0}Lt(t){this.Ot=t}delete(){return Jv(this.$t.delete())}}class Gv extends ig{constructor(t,n){super(ng.UNAVAILABLE,`IndexedDB transaction '${t}' failed: ${n}`),this.name="IndexedDbTransactionError"}}function Hv(t){return"IndexedDbTransactionError"===t.name}class Yv{constructor(t){this.store=t}put(t,n){let i;return void 0!==n?(Yp("SimpleDb","PUT",this.store.name,t,n),i=this.store.put(n,t)):(Yp("SimpleDb","PUT",this.store.name,"<auto-key>",t),i=this.store.put(t)),Jv(i)}add(t){return Yp("SimpleDb","ADD",this.store.name,t,t),Jv(this.store.add(t))}get(t){return Jv(this.store.get(t)).next((n=>(void 0===n&&(n=null),Yp("SimpleDb","GET",this.store.name,t,n),n)))}delete(t){return Yp("SimpleDb","DELETE",this.store.name,t),Jv(this.store.delete(t))}count(){return Yp("SimpleDb","COUNT",this.store.name),Jv(this.store.count())}Bt(t,n){const i=this.cursor(this.options(t,n)),e=[];return this.Ut(i,((t,n)=>{e.push(n)})).next((()=>e))}qt(t,n){Yp("SimpleDb","DELETE ALL",this.store.name);const i=this.options(t,n);i.Kt=!1;const e=this.cursor(i);return this.Ut(e,((t,n,i)=>i.delete()))}jt(t,n){let i;n?i=t:(i={},n=t);const e=this.cursor(i);return this.Ut(e,n)}Qt(t){const n=this.cursor({});return new zv(((i,e)=>{n.onerror=t=>{const n=Qv(t.target.error);e(n)},n.onsuccess=n=>{const e=n.target.result;e?t(e.primaryKey,e.value).next((t=>{t?e.continue():i()})):i()}}))}Ut(t,n){const i=[];return new zv(((e,s)=>{t.onerror=t=>{s(t.target.error)},t.onsuccess=t=>{const s=t.target.result;if(!s)return void e();const r=new Wv(s),o=n(s.primaryKey,s.value,r);if(o instanceof zv){const t=o.catch((t=>(r.done(),zv.reject(t))));i.push(t)}r.isDone?e():null===r.Mt?s.continue():s.continue(r.Mt)}})).next((()=>zv.waitFor(i)))}options(t,n){let i;return void 0!==t&&("string"==typeof t?i=t:n=t),{index:i,range:n}}cursor(t){let n="next";if(t.reverse&&(n="prev"),t.index){const i=this.store.index(t.index);return t.Kt?i.openKeyCursor(t.range,n):i.openCursor(t.range,n)}return this.store.openCursor(t.range,n)}}function Jv(t){return new zv(((n,i)=>{t.onsuccess=t=>{n(t.target.result)},t.onerror=t=>{const n=Qv(t.target.error);i(n)}}))}let Xv=!1;function Qv(t){const n=Kv.Pt(ln());if(n>=12.2&&n<13){const n="An internal error was encountered in the Indexed Database server";if(t.message.indexOf(n)>=0){const t=new ig("internal",`IOS_INDEXEDDB_BUG1: IndexedDb has thrown '${n}'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.`);return Xv||(Xv=!0,setTimeout((()=>{throw t}),0)),t}}return t}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mb(t){if(t.code!==ng.FAILED_PRECONDITION||t.message!==Vv)throw t;Yp("LocalStore","Unexpectedly lost primary lease")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t)}))),r}ke(t){let n=0;return t.store(Dv.store).jt(((t,i)=>{n+=Eb(i)})).next((()=>{const i=new Ov(n);return t.store(Ov.store).put(Ov.key,i)}))}Ne(t){const n=t.store(Tv.store),i=t.store(Sv.store);return n.Bt().next((n=>zv.forEach(n,(n=>{const e=IDBKeyRange.bound([n.userId,-1],[n.userId,n.lastAcknowledgedBatchId]);return i.Bt(Sv.userMutationsIndex,e).next((i=>zv.forEach(i,(i=>{tg(i.userId===n.userId);const e=hb(this.k,i);return _b(t,n.userId,e).next((()=>{}))}))))}))))}xe(t){const n=t.store(Pv.store),i=t.store(Dv.store);return t.store(Mv.store).get(Mv.key).next((t=>{const e=[];return i.jt((i=>{const s=new Eg(i),r=function(t){return[0,yv(t)]}(s);e.push(n.get(r).next((i=>i?zv.resolve():(i=>n.put(new Pv(0,yv(i),t.highestListenSequenceNumber)))(s))))})).next((()=>zv.waitFor(e)))}))}$e(t,n){t.createObjectStore(Lv.store,{keyPath:Lv.keyPath});const i=n.store(Lv.store),e=new vb,s=t=>{if(e.add(t)){const n=t.lastSegment(),e=t.popLast();return i.put({collectionId:n,parent:yv(e)})}};return n.store(Dv.store).jt({Kt:!0},(t=>{const n=new Eg(t);return s(n.popLast())})).next((()=>n.store(Cv.store).jt({Kt:!0},(([t,n,i])=>{const e=_v(n);return s(e.popLast())}))))}Fe(t){const n=t.store(Rv.store);return n.jt(((t,i)=>{const e=cb(i),s=db(this.k,e);return n.put(s)}))}}function Jb(t){t.createObjectStore(Pv.store,{keyPath:Pv.keyPath}).createIndex(Pv.documentTargetsIndex,Pv.documentTargetsKeyPath,{unique:!0}),t.createObjectStore(Rv.store,{keyPath:Rv.keyPath}).createIndex(Rv.queryTargetsIndexName,Rv.queryTargetsKeyPath,{unique:!0}),t.createObjectStore(Mv.store)}const Xb="Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.";class Qb{constructor(t,n,i,e,s,r,o,l,a,u){if(this.allowTabSynchronization=t,this.persistenceKey=n,this.clientId=i,this.Oe=s,this.window=r,this.document=o,this.Me=a,this.Le=u,this.Be=null,this.Ue=!1,this.isPrimary=!1,this.networkEnabled=!0,this.qe=null,this.inForeground=!1,this.Ke=null,this.je=null,this.Qe=Number.NEGATIVE_INFINITY,this.We=()=>Promise.resolve(),!Qb.bt())throw new ig(ng.UNIMPLEMENTED,"This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");this.referenceDelegate=new Ub(this,e),this.Ge=n+"main",this.k=new sb(l),this.ze=new Kv(this.Ge,11,new Yb(this.k)),this.He=new Db(this.referenceDelegate,this.k),this.Jt=new bb,this.Je=function(t,n){return new qb(t,n)}(this.k,this.Jt),this.Ye=new pb,this.window&&this.window.localStorage?this.Xe=this.window.localStorage:(this.Xe=null,!1===u&&Jp("IndexedDbPersistence","LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."))}start(){return this.Ze().then((()=>{if(!this.isPrimary&&!this.allowTabSynchronization)throw new ig(ng.FAILED_PRECONDITION,Xb);return this.tn(),this.en(),this.nn(),this.runTransaction("getHighestListenSequenceNumber","readonly",(t=>this.He.getHighestSequenceNumber(t)))})).then((t=>{this.Be=new dg(t,this.Me)})).then((()=>{this.Ue=!0})).catch((t=>(this.ze&&this.ze.close(),Promise.reject(t))))}sn(t){return this.We=async n=>{if(this.started)return t(n)},t(this.isPrimary)}setDatabaseDeletedListener(t){this.ze.xt((async n=>{null===n.newVersion&&await t()}))}setNetworkEnabled(t){this.networkEnabled!==t&&(this.networkEnabled=t,this.Oe.enqueueAndForget((async()=>{this.started&&await this.Ze()})))}Ze(){return this.runTransaction("updateClientMetadataAndTryBecomePrimary","readwrite",(t=>ty(t).put(new jv(this.clientId,Date.now(),this.networkEnabled,this.inForeground)).next((()=>{if(this.isPrimary)return this.rn(t).next((t=>{t||(this.isPrimary=!1,this.Oe.enqueueRetryable((()=>this.We(!1))))}))})).next((()=>this.on(t))).next((n=>this.isPrimary&&!n?this.an(t).next((()=>!1)):!!n&&this.cn(t).next((()=>!0)))))).catch((t=>{if(Hv(t))return Yp("IndexedDbPersistence","Failed to extend owner lease: ",t),this.isPrimary;if(!this.allowTabSynchronization)throw t;return Yp("IndexedDbPersistence","Releasing owner lease after error during lease refresh",t),!1})).then((t=>{this.isPrimary!==t&&this.Oe.enqueueRetryable((()=>this.We(t))),this.isPrimary=t}))}rn(t){return Zb(t).get(Iv.key).next((t=>zv.resolve(this.un(t))))}hn(t){return ty(t).delete(this.clientId)}async ln(){if(this.isPrimary&&!this.fn(this.Qe,18e5)){this.Qe=Date.now();const t=await this.runTransaction("maybeGarbageCollectMultiClientState","readwrite-primary",(t=>{const n=tb(t,jv.store);return n.Bt().next((t=>{const i=this.dn(t,18e5),e=t.filter((t=>-1===i.indexOf(t)));return zv.forEach(e,(t=>n.delete(t.clientId))).next((()=>e))}))})).catch((()=>[]));if(this.Xe)for(const n of t)this.Xe.removeItem(this.wn(n.clientId))}}nn(){this.je=this.Oe.enqueueAfterDelay("client_metadata_refresh",4e3,(()=>this.Ze().then((()=>this.ln())).then((()=>this.nn()))))}un(t){return!!t&&t.ownerId===this.clientId}on(t){return this.Le?zv.resolve(!0):Zb(t).get(Iv.key).next((n=>{if(null!==n&&this.fn(n.leaseTimestampMs,5e3)&&!this._n(n.ownerId)){if(this.un(n)&&this.networkEnabled)return!0;if(!this.un(n)){if(!n.allowTabSynchronization)throw new ig(ng.FAILED_PRECONDITION,Xb);return!1}}return!(!this.networkEnabled||!this.inForeground)||ty(t).Bt().next((t=>void 0===this.dn(t,5e3).find((t=>{if(this.clientId!==t.clientId){const n=!this.inForeground&&t.inForeground,i=this.networkEnabled===t.networkEnabled;if(!this.networkEnabled&&t.networkEnabled||n&&i)return!0}return!1}))))})).next((t=>(this.isPrimary!==t&&Yp("IndexedDbPersistence",`Client ${t?"is":"is not"} eligible for a primary lease.`),t)))}async shutdown(){this.Ue=!1,this.mn(),this.je&&(this.je.cancel(),this.je=null),this.gn(),this.yn(),await this.ze.runTransaction("shutdown","readwrite",[Iv.store,jv.store],(t=>{const n=new Zv(t,dg.I);return this.an(n).next((()=>this.hn(n)))})),this.ze.close(),this.pn()}dn(t,n){return t.filter((t=>this.fn(t.updateTimeMs,n)&&!this._n(t.clientId)))}Tn(){return this.runTransaction("getActiveClients","readonly",(t=>ty(t).Bt().next((t=>this.dn(t,18e5).map((t=>t.clientId))))))}get started(){return this.Ue}getMutationQueue(t){return Ib.Xt(t,this.k,this.Jt,this.referenceDelegate)}getTargetCache(){return this.He}getRemoteDocumentCache(){return this.Je}getIndexManager(){return this.Jt}getBundleCache(){return this.Ye}runTransaction(t,n,i){let e;return Yp("IndexedDbPersistence","Starting transaction:",t),this.ze.runTransaction(t,"readonly"===n?"readonly":"readwrite",Uv,(s=>(e=new Zv(s,this.Be?this.Be.next():dg.I),"readwrite-primary"===n?this.rn(e).next((t=>!!t||this.on(e))).next((n=>{if(!n)throw Jp(`Failed to obtain primary lease for action '${t}'.`),this.isPrimary=!1,this.Oe.enqueueRetryable((()=>this.We(!1))),new ig(ng.FAILED_PRECONDITION,Vv);return i(e)})).next((t=>this.cn(e).next((()=>t)))):this.En(e).next((()=>i(e)))))).then((t=>(e.raiseOnCommittedEvent(),t)))}En(t){return Zb(t).get(Iv.key).next((t=>{if(null!==t&&this.fn(t.leaseTimestampMs,5e3)&&!this._n(t.ownerId)&&!this.un(t)&&!(this.Le||this.allowTabSynchronization&&t.allowTabSynchronization))throw new ig(ng.FAILED_PRECONDITION,Xb)}))}cn(t){const n=new Iv(this.clientId,this.allowTabSynchronization,Date.now());return Zb(t).put(Iv.key,n)}static bt(){return Kv.bt()}an(t){const n=Zb(t);return n.get(Iv.key).next((t=>this.un(t)?(Yp("IndexedDbPersistence","Releasing primary lease."),n.delete(Iv.key)):zv.resolve()))}fn(t,n){const i=Date.now();return!(t<i-n||t>i&&(Jp(`Detected an update time that is in the future: ${t} > ${i}`),1))}tn(){null!==this.document&&"function"==typeof this.document.addEventListener&&(this.Ke=()=>{this.Oe.enqueueAndForget((()=>(this.inForeground="visible"===this.document.visibilityState,this.Ze())))},this.document.addEventListener("visibilitychange",this.Ke),this.inForeground="visible"===this.document.visibilityState)}gn(){this.Ke&&(this.document.removeEventListener("visibilitychange",this.Ke),this.Ke=null)}en(){var t;"function"==typeof(null===(t=this.window)||void 0===t?void 0:t.addEventListener)&&(this.qe=()=>{this.mn(),!function(){try{return"[object process]"===Object.prototype.toString.call(global.process)}catch(t){return!1}}()&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")&&navigator.appVersion.match(/Version\/1[45]/)&&this.Oe.enterRestrictedMode(!0),this.Oe.enqueueAndForget((()=>this.shutdown()))},this.window.addEventListener("pagehide",this.qe))}yn(){this.qe&&(this.window.removeEventListener("pagehide",this.qe),this.qe=null)}_n(t){var n;try{const i=null!==(null===(n=this.Xe)||void 0===n?void 0:n.getItem(this.wn(t)));return Yp("IndexedDbPersistence",`Client '${t}' ${i?"is":"is not"} zombied in LocalStorage`),i}catch(t){return Jp("IndexedDbPersistence","Failed to get zombied client id.",t),!1}}mn(){if(this.Xe)try{this.Xe.setItem(this.wn(this.clientId),String(Date.now()))}catch(t){Jp("Failed to set zombie client id.",t)}}pn(){if(this.Xe)try{this.Xe.removeItem(this.wn(this.clientId))}catch(t){}}wn(t){return`firestore_zombie_${this.persistenceKey}_${t}`}}function Zb(t){return tb(t,Iv.store)}function ty(t){return tb(t,jv.store)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ey{Fn(t){this.On=t}getDocumentsMatchingQuery(t,n,i,e){return function(t){return 0===t.filters.length&&null===t.limit&&null==t.startAt&&null==t.endAt&&(0===t.explicitOrderBy.length||1===t.explicitOrderBy.length&&t.explicitOrderBy[0].field.isKeyField())}(n)||i.isEqual(bg.min())?this.Mn(t,n):this.On.vn(t,e).next((s=>{const r=this.Ln(n,s);return(Em(n)||Im(n))&&this.Bn(n.limitType,r,e,i)?this.Mn(t,n):(Hp()<=jn.DEBUG&&Yp("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Pm(n)),this.On.getDocumentsMatchingQuery(t,n,i).next((t=>(r.forEach((n=>{t=t.insert(n.key,n)})),t))))}))}Ln(t,n){let i=new kw(Lm(t));return n.forEach(((n,e)=>{Mm(t,e)&&(i=i.add(e))})),i}Bn(t,n,i,e){if(i.size!==n.size)return!0;const s="F"===t?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(e)>0)}Mn(t,n){return Hp()<=jn.DEBUG&&Yp("QueryEngine","Using full collection scan to execute query:",Pm(n)),this.On.getDocumentsMatchingQuery(t,n,bg.min())}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sy extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId,this.Mi=(t.ssl?"https":"http")+"://"+t.host,this.Li="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}Bi(t,n,i,e,s){const r=this.Ui(t,n);Yp("RestConnection","Sending: ",r,i);const o={};return this.qi(o,e,s),this.Ki(t,r,o,i).then((t=>(Yp("RestConnection","Received: ",t),t)),(n=>{throw Xp("RestConnection",`${t} failed with error: `,n,"url: ",r,"request:",i),n}))}ji(t,n,i,e,s){return this.Bi(t,n,i,e,s)}qi(t,n,i){t["X-Goog-Api-Client"]="gl-js/ fire/"+Wp,t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),n&&n.headers.forEach(((n,i)=>t[i]=n)),i&&i.headers.forEach(((n,i)=>t[i]=n))}Ui(t,n){return`${this.Mi}/v1/${n}:${Iy[t]}`}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams}Ki(t,n,i,e){return new Promise(((s,r)=>{const o=new zp;o.listenOnce($p.COMPLETE,(()=>{try{switch(o.getLastErrorCode()){case Fp.NO_ERROR:const n=o.getResponseJson();Yp("Connection","XHR received:",JSON.stringify(n)),s(n);break;case Fp.TIMEOUT:Yp("Connection",'RPC "'+t+'" timed out'),r(new ig(ng.DEADLINE_EXCEEDED,"Request time out"));break;case Fp.HTTP_ERROR:const i=o.getStatus();if(Yp("Connection",'RPC "'+t+'" failed with status:',i,"response text:",o.getResponseText()),i>0){const t=o.getResponseJson().error;if(t&&t.status&&t.message){const n=function(t){const n=t.toLowerCase().replace(/_/g,"-");return Object.values(ng).indexOf(n)>=0?n:ng.UNKNOWN}(t.status);r(new ig(n,t.message))}else r(new ig(ng.UNKNOWN,"Server responded with status "+o.getStatus()))}else r(new ig(ng.UNAVAILABLE,"Connection failed."));break;default:Zp()}}finally{Yp("Connection",'RPC "'+t+'" completed.')}}));const l=JSON.stringify(e);o.send(n,"POST",l,i,15)}))}Qi(t,n,i){const e=[this.Mi,"/","google.firestore.v1.Firestore","/",t,"/channel"],s=new Rp,r=Sd(),o={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling};this.useFetchStreams&&(o.xmlHttpFactory=new Vp({})),this.qi(o.initMessageHeaders,n,i),an()||hn()||ln().indexOf("Electron/")>=0||cn()||ln().indexOf("MSAppHost/")>=0||un()||(o.httpHeadersOverwriteParam="$httpHeaders");const l=e.join("");Yp("Connection","Creating WebChannel: "+l,o);const a=s.createWebChannel(l,o);let u=!1,h=!1;const c=new Ty({Vi:t=>{h?Yp("Connection","Not sending because WebChannel is closed:",t):(u||(Yp("Connection","Opening WebChannel transport."),a.open(),u=!0),Yp("Connection","WebChannel sending:",t),a.send(t))},Si:()=>a.close()}),d=(t,n,i)=>{t.listen(n,(t=>{try{i(t)}catch(t){setTimeout((()=>{throw t}),0)}}))};return d(a,Bp.EventType.OPEN,(()=>{h||Yp("Connection","WebChannel transport opened.")})),d(a,Bp.EventType.CLOSE,(()=>{h||(h=!0,Yp("Connection","WebChannel transport closed"),c.Fi())})),d(a,Bp.EventType.ERROR,(t=>{h||(h=!0,Xp("Connection","WebChannel transport errored:",t),c.Fi(new ig(ng.UNAVAILABLE,"The operation could not be completed")))})),d(a,Bp.EventType.MESSAGE,(t=>{var n;if(!h){const i=t.data[0];tg(!!i);const e=i,s=e.error||(null===(n=e[0])||void 0===n?void 0:n.error);if(s){Yp("Connection","WebChannel received error:",s);const t=s.status;let n=function(t){const n=mw[t];if(void 0!==n)return vw(n)}(t),i=s.message;void 0===n&&(n=ng.INTERNAL,i="Unknown error status: "+t+" with message "+s.message),h=!0,c.Fi(new ig(n,i)),a.close()}else Yp("Connection","WebChannel received:",i),c.Oi(i)}})),d(r,Up.STAT_EVENT,(t=>{10===t.stat?Yp("Connection","Detected buffering proxy"):11===t.stat&&Yp("Connection","Detected no buffering proxy")})),setTimeout((()=>{c.$i()}),0),c}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yx{constructor(t){this.observer=t,this.muted=!1}next(t){this.observer.next&&this.ea(this.observer.next,t)}error(t){this.observer.error?this.ea(this.observer.error,t):console.error("Uncaught Error in snapshot listener:",t)}na(){this.muted=!0}ea(t,n){this.muted||setTimeout((()=>{this.muted||t(n)}),0)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */!function(t,n=!0){Wp="9.6.1",Jn(new Pn("firestore",((t,{options:i})=>{const e=t.getProvider("app").getImmediate(),s=new wk(e,new lg(t.getProvider("auth-internal")),new cg(t.getProvider("app-check-internal")));return i=Object.assign({useFetchStreams:n},i),s._setSettings(i),s}),"PUBLIC")),ni(qp,"3.4.1",t),ni(qp,"3.4.1","esm2017")}();const f_={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};
/**
 * @license
 * Copyright 2017 Google LLC
 *
