...
const ClipboardJS = /*@__PURE__*/getDefaultExportFromCjs(clipboard);
...
let Share = class {
  ...
  render() {
    return (h("ion-list", null, h("ion-item", { lines: this.lines, class: "share-twitter", onClick: (event) => this.openPopup(event, "twitter") }, h("ion-icon", { slot: "end", name: "logo-twitter" }), "Share on Twitter"), h("ion-item", { lines: this.lines, class: "share-facebook", onClick: (event) => this.openPopup(event, "facebook") }, h("ion-icon", { slot: "end", name: "logo-facebook" }), "Share on Facebook"), h("ion-item", { lines: this.lines, ref: (el) => (this.copyItemEl = el), class: "share-clipboard", "data-clipboard-text": this.url }, h("ion-icon", { slot: "end", name: "clipboard" }), "Copy to Clipboard")));
  }
};
Share.style = shareCss;

export { Share as fireenjin_share };
