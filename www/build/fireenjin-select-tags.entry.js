...
let SelectTags = class {
    ...
    try {
      this.choices = new Choices(this.choicesEl, {
        ...
        callbackOnCreateTemplates: (template) => {
          return {
            input: (...args) => {
              return Object.assign(Choices.defaults.templates.input.call(this, ...args), {
            ...
            item: (classNames, data) => {
              return template(`
                ...
                : classNames.itemSelectable}" data-item data-deletable data-id="${data.id}" data-value="${data.value}" ${data.active ? 'aria-selected="true"' : ""} ${data.disabled ? 'aria-disabled="true"' : ""}>
            ...
            choice: (classNames, data) => {
              return template(`
                ...
                : classNames.itemSelectable}" data-choice ${data.disabled
  ...
  render() {
    ...
    return (h("ion-item", { ref: (el) => (this.itemEl = el), lines: this.lines }, this.label && h("ion-label", { position: this.labelPosition }, this.label), h("select", { disabled: this.disabled, multiple: this.multiple, name: this.name, required: this.required, ref: (el) => (this.choicesEl = el) }, h("slot", null), !this.multiple && this.placeholder ? (h(OptionEl, { placeholder: true }, this.placeholder)) : null, this.options.map((option) => (h("option", { selected: this.multiple
