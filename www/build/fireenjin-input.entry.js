import { r as registerInstance, f as createEvent, j as Build, n as forceUpdate, h, i as getElement } from './index-7ecca5a2.js';
...
let Input = class {
  ...
  initializeStripeElements() {
    ...
    this.stripe = ((window === null || window === void 0 ? void 0 : window.Stripe) ? window.Stripe : loadStripe)(this.stripeKey);
  ...
  render() {
    return (h("ion-item", { ref: el => (this.itemEl = el), lines: this.lines, class: {
        "input-password item-input": this.inputType === "password",
        "input-card": this.inputType === "card",
        "has-info-bubble": !!this.info
      } }, this.iconLeft && h("ion-icon", { name: this.iconLeft, slot: "start" }), this.label && (h("ion-label", { position: this.labelPosition }, h("span", null, this.label))), this.renderInput(), this.type === "password" && (h("div", { class: "input-icon" }, h("ion-icon", { name: this.passwordVisible ? "eye-off" : "eye", onClick: (event) => this.togglePassword(event) }))), this.iconRight && h("ion-icon", { name: this.iconRight, slot: "start" })));
  }
...
export { Input as fireenjin_input };
