...
function formatDuration(duration) {
  ...
  var result = format.reduce(function (acc, unit) {
    ...
    return addChunk && locale$1.formatDistance ? acc.concat(locale$1.formatDistance(token, duration[unit])) : acc;
  }, []).join(delimiter);
  return result;
}
...
function formatRelative(dirtyDate, dirtyBaseDate, dirtyOptions) {
  ...
  var _ref = dirtyOptions || {},
      ...
      locale$1 = _ref$locale === void 0 ? locale : _ref$locale,
...
let LogItem = class {
  ...
  render() {
    return (h("ion-item", { lines: this.lines }, h("ion-label", { class: "ion-text-wrap" }, h("ion-grid", null, h("ion-row", null, h("ion-col", null, h("h2", null, this.type, " - ", this.name, " ", this.resolveTime ? `(${this.resolveTime}ms)` : "")), h("ion-col", { style: {
        display: "flex",
        justifyContent: "flex-end",
      } }, h("small", { style: {
        color: "var(--ion-color-medium)",
      } }, this.formatDate(this.createdAt)))), h("ion-row", null, h("ion-col", null, h("h3", null, "Input"), h("fireenjin-json-viewer", { innerHTML: typeof this.input === "object"
        ? JSON.stringify(this.input)
        : this.input })), h("ion-col", null, h("h3", null, "Output"), h("fireenjin-json-viewer", { innerHTML: typeof this.output === "object"
        ? JSON.stringify(this.output)
        : this.output })))))));
  }
};
LogItem.style = logItemCss;

export { LogItem as fireenjin_log_item };
